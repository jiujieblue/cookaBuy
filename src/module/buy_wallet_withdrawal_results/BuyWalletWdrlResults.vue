<style lang="less">
	...
	@import '../../assets/less/BuyWalletWdrlResults.less';
</style>
...
<div id='buyWalletWdrlResults'>
	...
	<div class='container'>
			<div class="row">
				...
				<div class="col-md-10">
					<div class="buyWalletWdrlResults">
						...
						<div class="buyWalletWdrlResults-status">
							...
							<ul>
								<li>
									<span>申请时间：</span>2016-07-01<i class="em"></i>16 : 58
								</li>
								<li>
									<span>提 现 到：</span>***************5155<i class="em"></i>科比
								</li>
								<li>
									<span>持 卡 人：</span>科比
								</li>
								...
								<li v-if="status == 2">
									<span>到账时间：</span>2016-07-01<i class="em"></i>16 : 58
								</li>
								<li v-if="status == 3">
									<span>失败原因：</span>
									<ul>
