<style lang="less">
	...
	@import '../../assets/less/buyerWalletBalance.less';
</style>

<template>
<div id='buyerWalletBalance'>
	...
	<div class='container'>
	  	<div class="row">
	  		...
	  		<div class="buyerWalletBalance col-md-10">
	  			<div class="buyerWalletBalance-container">
		  			<div class="buyerWalletBalance-container-top">
		  				<div class="buyerWalletBalance-container-top-title">
		  					<span>当前位置：我的钱包></span>钱包余额
		  				</div>
		  				<div class="buyerWalletBalance-container-top-info">
		  					<ul>
		  						<li>
		  							<ul>
		  								<li>
		  									<a href=""><img src="../../assets/images/user.gif" alt="买家头像"></a>
		  									郑思远
		  								</li>
			  							<li :class="[shimingyanzheng ? 'beenset' : 'notset']">
				  							<link class="icon-shimingyanzheng" />
				  							未实名验证
			  							</li>
			  							<li :class="[zhifumima ? 'beenset' : 'notset']">
				  							<link class="icon-zhifumima" />
				  							未设置支付密码
			  							</li>
			  							<li :class="[bangdingshouji ? 'beenset' : 'notset']">
				  							<link class="icon-bangdingshouji" />
				  							已绑定手机
			  							</li>
		  							</ul>
		  						</li>
		  						<li>
		  							<ul>
		  								<li>
		  									<span>我的余额：<b>0.00</b>元</span><a>提现记录</a>
		  								</li>
		  								<li>
				  							<button>提<span class="em"></span>现</button>
				  							<button>去<span class="em_2"></span>付<span class="em_2"></span>款</button>
		  								</li>
		  							</ul>
		  						</li>
		  						<li>
		  				...
		  				<div class="buyerWalletBalance-container-top-detail">
		  					<h4>交易明细</h4>
		  					<table>
		  						<tr>
		  							<td>	
		  							...
		  							<td>
		  								<button>搜<span class="em"></span>索</button>
		  			...
		  			<div class="buyerWalletBalance-container-list">
		  				<table>
		  					<tr>
		  						<th>时间</th>
		  						<th>订单</th>
