				...
				<div class="buyFootprint-right">
					...
					<div class="buyFootprint-right-container">
						...
						<div class="buyFootprint-right-container-list">
							<ul class="buyFootprint-right-container-list-nav">
								<li>
							...
							<ul class="buyFootprint-right-container-list-main" v-for="(footprints,index1,i) in footprintsObj" v-if="footprints">
								<li>
