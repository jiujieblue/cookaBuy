<style lang="less">
	...
	@import '../../assets/less/buyerWalletWdrlRecord.less';
</style>

<template>
<div id='buyerWalletWdrlRecord'>
	...
	<div class='container'>
	  	<div class="row">
	  		...
	  		<div class="buyerWalletWdrlRecord col-md-10">
	  			<div class="buyerWalletWdrlRecord-container">
		  			<div class="buyerWalletWdrlRecord-container-top">
		  				<div class="buyerWalletWdrlRecord-container-top-title">
		  					<span>当前位置：我的钱包></span>钱包余额
		  				</div>
		  				<div class="buyerWalletWdrlRecord-container-top-record">
		  					<p>提现记录</p>
		  					<ul>
		  				...
		  				<div class="buyerWalletWdrlRecord-container-top-detail">
		  					<table>
		  						<tr>
		  							<td>	
			  							时间范围：
		  			...
		  			<div class="buyerWalletWdrlRecord-container-list">
		  				<table>
		  					<tr>
		  						<th>时间</th>
		  						<th>订单</th>
