<style lang="less">
	...
	@import '../../assets/less/buyerUserCenter.less';
</style>

<template>
<div id='buyerUserCenter'>
				...
				<div class="userCenter">
					<div class="userCenter-top">
						<div class="userCenter-top-info">
							<a href="">
								<img src="../../assets/images/user.gif" alt="用户头像">
							</a>
							<ul>
								...
								<li>
									...
									优惠券：共计<span>0</span>张
								</li>
							</ul>
							<p>
								上次登录：2016-08-22 15:25:05
							</p>
						</div>
						<div class="userCenter-top-announcement">
							<p>
						...
						<div class="userCenter-myorder-container">
							...
							<ul v-if="isMyorder">
								<li>
									...
									<ul>
										<li>
											<a href=""><img src="../../assets/images/cart-show.jpg" alt="商品图片"></a>
											<ul>
												<li><b>$2555.00</b>含运费（￥22.00）</li>
												<li>共1款；合计5件</li>
											</ul>
										</li>
										<li>
											<ul>
												<li>您已下单，待完成付款</li>
												<li>2016-08-31&nbsp;&nbsp;14:31:52 <a href="">查看详情</a></li>
											</ul>
										</li>
										<li>
											<button>马上付款</button>
					...
					<div class="userCenter-productcollection public">
						<p class="public-nav">
					...
					<div class="userCenter-storeFocus public">
						<p class="public-nav">
						...
						<ul class="public-container" v-if="storeFocus">
							<li>
								<a href="">
									<b>SHOP</b>
									<img src="../../assets/images/shoucan.gif" alt="商品收藏图片">
									<span>上新255件</span>
								</a>
								<p>￥220.00~230.00</p>
							</li>
					...
					<div class="userCenter-footprint public">
						<p class="public-nav">
						...
						<ul v-if="footprint">
							<li>
								...
								<ul>
									<li><a href="">YINMAN女装紧身短装 2016春秋装2016春秋装新款</a></li>
									<li>￥120.00~138.00</li>
								</ul>
							</li>
							<li>
