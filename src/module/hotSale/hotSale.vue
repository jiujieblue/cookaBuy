										...
										<ul>
											...
											<li v-for="(girlItem, girlIndex) in girlData" :class="_reGirlCla(girlIndex)">
												<div class="hotsalepage-left-womenhotsale-links-item">
													<a :title="girlItem.title" @click="_toGirlDetail(girlIndex)"><img :src="girlItem.pic_url" :title="girlItem.item.title" :alt="girlItem.item.title" /></a>
										...
										<ul>
											...
											<li v-for="(boyItem, boyIndex) in boyData" :class="_reBoyCla(boyIndex)">
												<div class="hotsalepage-left-manhotsale-links-item">
													<a :title="boyItem.title" @click="_toBoyDetail(boyIndex)"><img :src="boyItem.pic_url" :title="boyItem.item.title" :alt="boyItem.item.title"/></a>
