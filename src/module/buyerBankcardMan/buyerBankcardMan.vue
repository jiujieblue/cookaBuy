<style lang="less">
	...
	@import '../../assets/less/buyerBankcardMan.less';
</style>

<template>
<div id='buyerBankcardMan'>
	<BuyerCenterHeader></BuyerCenterHeader>
	<div class="container buyerBankcardMan">
		<div class="row">
				<div class="col-md-2">
					<BuyerCenterSideBar></BuyerCenterSideBar>
				</div>
				<div class="col-md-10">
					<div class="buyerBankcardMan-right">
						<div class="buyerBankcardMan-right-title"><span>当前位置：我的钱包 > </span>银行卡管理</div>
						<div class="buyerBankcardMan-right-card">
							<p>我的银行卡</p>
							<ul>
								<li>
									<ul>
